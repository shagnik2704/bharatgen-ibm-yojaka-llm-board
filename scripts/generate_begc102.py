"""
BEGC102 Batch Question Generator
=================================
Generates questions across all blocks for BEGC 102.

Uses asyncio + httpx for concurrent requests.
Model: ollama-gemma4-31b

Usage:
    python3 scripts/generate_begc102.py              # fresh run
    python3 scripts/generate_begc102.py --resume     # skip already-completed jobs
"""
...
OUTPUT_CSV = Path(__file__).parent.parent / "output" / "begc102_questions.csv"
...
def get_all_jobs():
    """
    Build the job list for BEGC 102 blocks.
    """
...
async def main():
    ...
    print("=" * 65)
    print("BEGC102 Batch Question Generator")
