...
OUTPUT_CSV = Path(__file__).parent.parent / "output" / "10_marks_questions.csv"
...
def get_all_jobs():
    ...
    bloom_levels = [
        ("Level 4", "Bloom level 4: Analyze"),
        ("Level 3", "Bloom level 3: Apply"),
    ]
...
async def main():
    ...
    print("=" * 65)
    print("10 Marks Batch Question Generator")
