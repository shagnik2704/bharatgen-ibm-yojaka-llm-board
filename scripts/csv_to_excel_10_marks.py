"""
CSV → Excel Converter (BEGC102/20 Marks)
=========================================
Reads 10_marks_questions.csv and produces a beautifully formatted
10_marks_questions.xlsx file.

Usage:
    python3 scripts/csv_to_excel_begc102.py
"""
...
INPUT_CSV = Path(__file__).parent.parent / "output" / "10_marks_questions.csv"
OUTPUT_XLSX = Path(__file__).parent.parent / "output" / "10_marks_questions.xlsx"
